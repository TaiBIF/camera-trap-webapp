<template>
  <div class="container">
    ...
    <form action="" class="form">
      ...
      <div v-if="form.type==1" class="panel panel-default mb-3">
      ...
      <div v-if="form.type==1" class="action">
        <button type="reset" class="btn btn-green-border">取消</button>
        <button type="submit" class="btn btn-orange">確認送出</button>
      </div>
      <div v-if="form.type==2" class="panel panel-default mb-3">
        <div class="panel-heading">
          <h4>意見反饋</h4>
        </div>
        <div class="panel-body">
      ...
      <div v-if="form.type==2" class="action">
        <button type="reset" class="btn btn-green-border">取消</button>
        <button type="submit" class="btn btn-orange">確認送出</button>
      </div>
      <div v-if="form.type==''">
        <router-link to="/faq" class="btn btn-green-border">
          返回常見問題
        </router-link>
      </div>
    </form>
