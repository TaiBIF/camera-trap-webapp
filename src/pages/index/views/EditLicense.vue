  ...
  <div class="container page-project-edit">
    <div class="row">
      ...
      <div class="col-10 pt-3">
        <!-- 創用 CC 授權 -->
        <form class="form form-horizontal" @submit.stop.prevent="doSubmit()">
          <div class="panel">
              ...
              <div class="form-group row">
                ...
                <div class="d-inline-block pl-3">
                  <div class="input-group">
                    <date-picker v-model="licenseForm.public_at" :placeholder="'18/9/20'" :format="'YY/M/DD'" :first-day-of-week="1"></date-picker>
