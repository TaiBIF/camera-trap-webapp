          ...
          <form action="" class="form" @submit.stop.prevent="submitSearch()">
            ...
            :key="`data-form-${did}`">
              ...
              <div class="form-action">
                <a v-if="did>0" @click="removeFormData(did)"><span class="icon-remove"></span></a>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row">
              <div class="col-12">
                <hr>
                <a class="link" @click="advSecOpen=!advSecOpen">
              ...
              <div class="row">
                ...
                <div class="col-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="請選擇被註內容">
                  </div>
                </div>
              </div>
              <div class="row">
